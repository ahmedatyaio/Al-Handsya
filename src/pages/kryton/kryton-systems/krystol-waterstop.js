  ...
  return (
    <Layout>
      ...
      <StyledWhy>
        ...
        <Img className="photo" fluid={data.krystol1.childImageSharp.fluid} />
        <Img className="photo" fluid={data.krystol2.childImageSharp.fluid} />
      </StyledWhy>
    </Layout>
  );
};
...
export const data = graphql`
  {
    ...
    krystol2: file(relativePath: { eq: "kryton/krystol2.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 900) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
